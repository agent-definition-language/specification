 ...
 *
 *   bun run scripts/build-schema.ts            # write core/_next/schema*.json
...
const DRAFT = path.join(ROOT, 'core', '_next');
...
console.log('\nwrote core/_next/schema.json and schema-strict.json (generated from model)');
